...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
       ...
       //  "Диспрозій","Гольмій","Ербій","Тулій","Ітербій","Лютецій",
        ...
        "Плюмбум", "Бісмут","Полоній","Астат","Радон","Францій","Радій","AAC","Резерфордій",
        "Дубній","Сіборгій","Борій","Гасій","Майтнерій","Дармштадтій","Рентгеній","Коперницій","Ніхоній","Флеровій",
        "Московій","Ліверморій","Теннессин","Оганесон"
        };
        bool[] IzotopAccessTable ={ //DONE 17
        true,true,true,true,true,true,true,false,false,true,false,true,true,true,true, //15 
        ...
        int[] IzotopsBegin = {
        1,3,6,7,10,11,13,0,0,20,0,24,23,28,31,32,35
         };
        int[] IzotopsEnd = {
        3,4,7,10,11,14,15,0,0,21,0,26,29,30,31,34,35
         };
        ...
        double[] Periods = { //in secs 
            -1, 3.7843E8, 2, 3, 8.2E-17, 5, 1.7976E11, 600, 8,
            ...
            12,13,14,1209600,7516800,17,18,3.9356928E19,
            20,21,22,23,24,25,
            3801600,1.577E8,28,29,30,31,32,33,34,
            35,36,

            76, 1.5673392E18,// Rb 

            38, 39,40,41,42,6.62256E12,44,
            45,46,47,2.4282E23,49,50,
            51,52,691200,54,9.461E8,
            56,57,58,59,60,6.307E7,62,
            63,64,65,66,67,68,69,
            70,71,72,73,6.394E6,75,76,77,
            78,79,80,81,82,

            1.160525E13,5.9918E25,432000, // Bi 

            11923200,0.16, //Po
            28800,259200,1320, 4.2626E9, 6.938E8, 4.41504E17, 1.00915E12,

            5.014224E12, 7.72632E12, 2.2485168E16, 1.41912E17,50400, // U

            6,62256E15,

            2.74363E9, 7.60018E11, 4.415E8, 1.040688E13, // Pu

            2.4598E11, 1.26144E15, 3.1536E11, 1.135E10, 4.147E7, 259200, 5400, 8,
            8,
        ...
        private void InitializeComponent()
        {
            ...
            this.button91.Location = new System.Drawing.Point(868, 574);
